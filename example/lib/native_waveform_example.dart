...
/// Example screen demonstrating native waveform visualization with dictation.
class NativeWaveformExampleScreen extends StatefulWidget {
  const NativeWaveformExampleScreen({super.key});

  @override
  State<NativeWaveformExampleScreen> createState() =>
      _NativeWaveformExampleScreenState();
}

class _NativeWaveformExampleScreenState
    extends State<NativeWaveformExampleScreen> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(
        middle: Text('Native Waveform Example'),
      ),
      child: SafeArea(
        child: Padding(
